...
/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vuex */ "./node_modules/vuex/dist/vuex.esm.js");
/* harmony import */ var _utils_AlertManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/AlertManager */ "./resources/js/components/utils/AlertManager.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapActions"])({
    ...
    toggleNoIndex: function toggleNoIndex() {
      var _this = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this.savingNoIndex = true;
                _context.next = 3;
                return _this.toggleIndexing(_this.page);

              case 3:
                response = _context.sent;
                _this.savingNoIndex = false;
              ...
              case 8:
                _utils_AlertManager__WEBPACK_IMPORTED_MODULE_2__["AlertManager"].success(response.message);
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_PagesTable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/PagesTable */ "./resources/js/components/PagesTable.vue");
/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! vuex */ "./node_modules/vuex/dist/vuex.esm.js");
/* harmony import */ var _components_utils_AlertManager__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/utils/AlertManager */ "./resources/js/components/utils/AlertManager.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'DashboardPage',
  components: {
    PagesTable: _components_PagesTable__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  data: function data() {
    return {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this.savingSettings = true;
                _context.next = 3;
                return _this.saveSettings(_this.settings);

              case 3:
                response = _context.sent;
                _this.savingSettings = false;
              ...
              case 8:
                _components_utils_AlertManager__WEBPACK_IMPORTED_MODULE_3__["AlertManager"].success(response.message);
      ...
      _c("div", { staticClass: "custom-control custom-switch" }, [
        _c("input", {
          ...
          attrs: {
            ...
            disabled: _vm.savingNoIndex
          },
          domProps: { checked: _vm.page.no_index },
          on: { change: _vm.toggleNoIndex }
        }),
        _vm._v(" "),
        _c("label", {
...
var render = function() {
  ...
  return _c("div", { staticClass: "dashboard-container w-full" }, [
    _c("div", { staticClass: "w-full" }, [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "mb-4 flex flex-col w-full" }, [
        _c("div", { staticClass: "w-full flex" }, [
          _c("div", { staticClass: "mb-4 w-1/4 mr-3" }, [
            _c(
              "label",
              {
                staticClass: "block text-gray-700 text-sm font-bold mb-2",
                attrs: { for: "google_analytics_tag" }
              },
            ...
            _c("textarea", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.settings.google_analytics_tag,
                  expression: "settings.google_analytics_tag"
                }
              ],
              staticClass:
              ...
              domProps: { value: _vm.settings.google_analytics_tag },
              on: {
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.settings.facebook_pixel_data,
                  expression: "settings.facebook_pixel_data"
                }
              ],
              staticClass:
                "appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white",
              attrs: {
                name: "facebook_pixel_data",
                id: "facebook_pixel_data",
                placeholder: "Facebook pixel data",
                rows: "5",
                cols: "5"
              },
              domProps: { value: _vm.settings.facebook_pixel_data },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
          ...
          _c("div", { staticClass: "mb-4 w-1/4" }, [
            ...
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.settings.contact_email,
                  expression: "settings.contact_email"
                }
              ],
              staticClass:
                "appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white",
              ...
              domProps: { value: _vm.settings.contact_email },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.settings, "contact_email", $event.target.value)
                }
              }
            })
          ])
        ...
        _c("div", { staticClass: "w-auto" }, [
          _c(
            "button",
            {
              ...
              attrs: { type: "button", disabled: _vm.savingSettings },
    ...
    _c(
      ...
      [
        _c(
          "h2",
          { staticClass: "text-3xl\tfont-semibold text-gray-700 mb-8" },
...
var toggleNoIndex = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return Object(_api__WEBPACK_IMPORTED_MODULE_1__["toggleNoIndex"])(page);
  ...
  return function toggleNoIndex(_x, _x2) {
    return _ref2.apply(this, arguments);
  };
}();

var updateSettings = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(_ref3, page) {
    var commit, response;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return Object(_api__WEBPACK_IMPORTED_MODULE_1__["saveSettings"])(page);
...
/*!*****************************!*\
  !*** ./resources/js/api.js ***!
  \*****************************/
/*! exports provided: toggleNoIndex, saveSettings */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toggleNoIndex", function() { return toggleNoIndex; });
...
var toggleNoIndex = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_1___default.a.post("/page/".concat(page.id, "/toggle-no-index"));
  ...
  return function toggleNoIndex(_x) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_1___default.a.post("/settings", _objectSpread({}, settings));
...
/***/ "./resources/js/components/utils/AlertManager.js":
/*!*******************************************************!*\
  !*** ./resources/js/components/utils/AlertManager.js ***!
  \*******************************************************/
...
var AlertManager = {
  ...
  error: function error(message, options) {
    ...
    izitoast__WEBPACK_IMPORTED_MODULE_0___default.a.error(options);
  },
  success: function success(message, options) {
    ...
    izitoast__WEBPACK_IMPORTED_MODULE_0___default.a.success(options);
  }
};
...
var SET_GAT = function SET_GAT(state, payload) {
  state.settings = _objectSpread(_objectSpread({}, state.settings), {}, {
    google_analytics_tag: payload.gat
  });
};

var SET_FPX = function SET_FPX(state, payload) {
  state.settings = _objectSpread(_objectSpread({}, state.settings), {}, {
    facebook_pixel_data: payload.fpx
  });
};

var SET_CONTACT_EMAIL = function SET_CONTACT_EMAIL(state, payload) {
  state.settings = _objectSpread(_objectSpread({}, state.settings), {}, {
    contact_email: payload.contact_email
  });
};

var SET_SETTINGS = function SET_SETTINGS(state, settings) {
  state.settings = _objectSpread(_objectSpread({}, state.settings), settings);
};
