        ...
        _c("div", { staticClass: "w-full flex" }, [
          _c("div", { staticClass: "mb-4 w-1/4 mr-3" }, [
            ...
            _c("textarea", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.settings.gat,
                  expression: "settings.gat"
                }
              ],
              staticClass:
              ...
              domProps: { value: _vm.settings.gat },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.settings, "gat", $event.target.value)
                }
              }
            })
          ]),
          ...
          _c("div", { staticClass: "mb-4 w-1/4" }, [
            ...
            _c("textarea", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.settings.fpx,
                  expression: "settings.fpx"
                }
              ],
              staticClass:
                "appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white",
              ...
              domProps: { value: _vm.settings.fpx },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.settings, "fpx", $event.target.value)
                }
              }
            })
          ])
